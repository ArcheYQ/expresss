package com.example.administrator.expresss.activity.other;

import android.content.Context;
import android.os.Environment;

import com.example.administrator.expresss.activity.MyApplication;
...
public class InnerCache extends Cache {
  ...
  private File getCacheDirCreateIfNotExist() {
    File cachePath = new File(getInnerCacheDir(MyApplication.getContext()));
